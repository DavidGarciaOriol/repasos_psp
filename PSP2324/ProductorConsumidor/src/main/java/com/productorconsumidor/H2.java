...
public class H2 extends Thread {
	...
	public void run() {
		for (int i = 0; i < nveces; i++) {
			...
			if (letra == 0)
				System.out.println(this.getName() + ": no ha podido coger letra ya que no se habia depositado aún la letra");
			else
				System.out.println(this.getName() + " ha cogido la letra: " + letra);
		}
	}
}
